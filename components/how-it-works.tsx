...
export function HowItWorks() {
  return (
    <section id="how-it-works" className="bg-secondary/50 py-20 w-full lg:py-28">
      <div className="mx-auto w-full max-w-[1600px] px-4 sm:px-6 md:px-8">
        <div className="mx-auto mb-16 max-w-2xl text-center">
          ...
          <p className="mt-4 text-pretty text-lg leading-relaxed text-[#475569]">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {steps.map((step, idx) => (
            <div key={step.title} className="relative flex flex-col items-center text-center">
              ...
              <p className="max-w-xs leading-relaxed text-[#475569]">
                {step.description}
              </p>
            </div>
          ))}
